...
- (BOOL)getIsRetina;
{
    return [[SizeManager sharedInstance] _getIsRetina];
}

- (BOOL)getIsZoomedScreen;
{
    return [[SizeManager sharedInstance] _getIsZoomedScreen];
}

- (BOOL)getIsNarrowPhoneScreen;
{
    return [[SizeManager sharedInstance] _getIs4Screen] | [[SizeManager sharedInstance] _getIs5Screen];
}
...
{
    return [[SizeManager sharedInstance] _getIs4Screen];
}
...
{
    return [[SizeManager sharedInstance] _getIs5Screen];
}

- (BOOL)getIsIPhone6Screen
{
    return [[SizeManager sharedInstance] _getIs6Screen];
}

- (BOOL)getIsIPhone6PlusScreen
{
    return [[SizeManager sharedInstance] _getIs6PlusScreen];
}
