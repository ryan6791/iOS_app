...
#import "PodSizeManage.h"

@interface PodSizeManage()
{
    BOOL isRetina;
...
- (BOOL)getIsRetina;
{
    return [[PodSizeManage sharedInstance] _getIsRetina];
}

- (BOOL)getIsZoomedScreen;
{
    return [[PodSizeManage sharedInstance] _getIsZoomedScreen];
}

- (BOOL)getIsNarrowPhoneScreen;
{
    return [[PodSizeManage sharedInstance] _getIs4Screen] | [[PodSizeManage sharedInstance] _getIs5Screen];
}
...
{
    return [[PodSizeManage sharedInstance] _getIs4Screen];
}
...
{
    return [[PodSizeManage sharedInstance] _getIs5Screen];
}

- (BOOL)getIsIPhone6Screen
{
    return [[PodSizeManage sharedInstance] _getIs6Screen];
}

- (BOOL)getIsIPhone6PlusScreen
{
    return [[PodSizeManage sharedInstance] _getIs6PlusScreen];
}
