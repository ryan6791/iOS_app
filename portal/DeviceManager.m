...
- (BOOL)getIsRetina;
{
    return [[DeviceManager sharedInstance] _getIsRetina];
}

- (BOOL)getIsZoomedScreen;
{
    return [[DeviceManager sharedInstance] _getIsZoomedScreen];
}

- (BOOL)getIsNarrowPhoneScreen;
{
    return [[DeviceManager sharedInstance] _getIs4Screen] | [[DeviceManager sharedInstance] _getIs5Screen];
}
...
{
    return [[DeviceManager sharedInstance] _getIs4Screen];
}
...
{
    return [[DeviceManager sharedInstance] _getIs5Screen];
}

- (BOOL)getIsIPhone6Screen
{
    return [[DeviceManager sharedInstance] _getIs6Screen];
}

- (BOOL)getIsIPhone6PlusScreen
{
    return [[DeviceManager sharedInstance] _getIs6PlusScreen];
}
