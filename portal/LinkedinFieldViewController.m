...
- (void)addBoxUse {
 ...
 //   }
    ...
    if([[DataAccess singletonInstance] uselinkedinOption]){
...
- (void)addBox {
    ...
    if([[DataAccess singletonInstance] linkedinIsPublic]){
...
- (void)setupuseoptionLabel {
    ...
    self.optionUseLabel.text = @"Use Linkedin Account";
...
- (void)boxPressed:(id)sender {
    ...
    if([[DataAccess singletonInstance] linkedinIsPublic]){
        self.checkbox.image = [UIImage imageNamed:@"checkbox.png"];
        [[DataAccess singletonInstance] setlinkedinPublicStatus:NO];
        
    }else{
        self.checkbox.image = [UIImage imageNamed:@"checkedbox.png"];
        [[DataAccess singletonInstance] setlinkedinPublicStatus:YES];
    }
